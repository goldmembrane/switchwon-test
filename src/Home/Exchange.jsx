          ...
          <div className="exchange-info">
            <div className="exchange-information-container">
              <div className="exchange-information">
                ...
                <label className="exchange-currency-korean">미국 달러</label>
              </div>
              <div className="exchange-rate">
                {exchangeRateUSD ? `${exchangeRateUSD.rate}KRW` : "Loading..."}
              </div>
              <div
            ...
            <div className="exchange-information-container">
              <div className="exchange-information">
                ...
                <label className="exchange-currency-korean">일본 엔화</label>
              </div>
              <div className="exchange-rate">
                {exchangeRateJPY ? `${exchangeRateJPY.rate}KRW` : "Loading..."}
              </div>
              <div
                className={`exchange-percentage ${
        ...
        <div className="exchange-action-container">
          ...
          <div className="select-exchange-mode">
            <div
              className={`exchange-mode-button ${
                exchangeMode === "BUY" ? "selected mode-buy" : "mode-buy-label"
              }`}
          ...
          <div className="estimate-container">
            ...
            <div>
              ...
              >
                {exchangeMode === "BUY" ? "원 필요해요" : "원 받을 수 있어요"}
              </span>
            </div>
          </div>
          ...
          <button onClick={orderExchange} className="exchange-action-button">
            환전하기
          </button>
        </div>
      </div>
